...
if [ -e query.fa -o -e yes.O -o -e outfile -o -e outtree ]
then
...
~/bin/tblastn -db ~/termites/newdb/cut_nucls.fasta -db_gencode 5 -num_alignments 500 -query query.fa -out query.out-mitocode 1>/dev/null 2>/dev/null
...
/mnt/lustre/genkvg/perl5/perlbrew/perls/perl-5.28.1/bin/perl ~/bin/nuc_coding_mod2.pl query.out-mitocode_sel.hash ~/termites/newdb/cut_nucls.fasta 1>query.out-mitocode_sel.nuc 2>/dev/null
if [ -e query.out-mitocode_sel.nuc ]
then
/mnt/lustre/genkvg/perl5/perlbrew/perls/perl-5.28.1/bin/perl ~/bin/codon_alig_unique.pl query.out-mitocode_sel.nuc 1>query.out-mitocode_sel_unique.fa 2>/dev/null
...
/mnt/lustre/genkvg/perl5/perlbrew/perls/perl-5.28.1/bin/perl ~/bin/macse2.pl query.out-mitocode_sel_tranalign_unique.fa 1>/dev/null 2>/dev/null
/mnt/lustre/genkvg/perl5/perlbrew/perls/perl-5.28.1/bin/perl ~/bin/mutnumbers.pl query.out-mitocode_sel_tranalign_unique.fa 1>$SPNAME.$GENE.mutnumbers 2>/dev/null
...
/mnt/lustre/genkvg/perl5/perlbrew/perls/perl-5.28.1/bin/perl ~/bin/pars.pl RAxML_nodeLabelledRootedTree.ANCESTORS query.out-mitocode_sel_tranalign_unique.fa parsimony.tmp.MPancestors.fa 1>/dev/null 2>/dev/null
if [ -e parsimony.tmp.MPancestors.fa ]
then
/mnt/lustre/genkvg/perl5/perlbrew/perls/perl-5.28.1/bin/perl ~/bin/parscompare.pl RAxML_marginalAncestralStates.ANCESTORS parsimony.tmp.MPancestors.fa RAxML_nodeLabelledRootedTree.ANCESTORS.matrix $SPNAME.$GENE.CSancestors.fa 1>$SPNAME.$GENE.CSancestors.MPinc 2>/dev/null
